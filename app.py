...
def search_venues():
    ...
    #     }]
    # }
    search_item = request.form.get('search_term', '').strip()
    venues = Venue.query.filter(Venue.name.ilike('%' + search_item + '%')).all()
    # print(venues)
...
def search_artists():
    ...
    #     }]
    # }
    # similar to venue.search
    search_item = request.form.get('search_term', '').strip()
    artists = Artist.query.filter(Artist.name.ilike('%' + search_item + '%')).all()
    # print(artists)
